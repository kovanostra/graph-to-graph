...
class TestGRUMessenger(TestCase):
    def setUp(self) -> None:
        ...
        self.gru_messenger.w_tree_current_message_features = MULTIPLICATION_FACTOR * BASE_W_MATRIX
        ...
        self.gru_messenger.u_tree_current_message = MULTIPLICATION_FACTOR * BASE_W_MATRIX
        ...
        self.gru_messenger.b_tree_current_message = MULTIPLICATION_FACTOR * BASE_B_VECTOR
